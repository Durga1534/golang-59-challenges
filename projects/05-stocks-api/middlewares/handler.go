...
import (
	...
	"github.com/Durga1534/stocks-api/models"
...
func insertStock(stock models.Stock) int64 {
	...
	sqlStatement := `INSERT INTO stocks(name, company, price) VALUES($1, $2, $3) RETURNING stockid`
	var id int64
...
func updateStock(id int64, stock models.Stock) int64 {
	...
	sqlStatement := `UPDATE stocks SET name=$2, company=$3, price=$4 WHERE stockid=$1`
	res, err := db.Exec(sqlStatement, id, stock.Name, stock.Company, stock.Price)
	if err != nil {
		log.Fatalf("Unable to execute the query %v", err)
	}
